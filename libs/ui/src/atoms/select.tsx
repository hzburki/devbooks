    ...
    const selectElement = (
      <div ref={selectRef} className="relative">
        <button
          ...
          className={cn(
            'border-input bg-background text-foreground ring-offset-background flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 pr-10 text-sm focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
